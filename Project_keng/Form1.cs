...
namespace Project_keng
{
    public partial class Form1 : Form
    {
        ...
        {
            MessageBox.Show("เครื่องคิดเลข จัดทำโดย นายพิพัฒน์พงศ์ ฉายาวัตน์ รหัส 553266151 16.3", "เกี่ยวกับ");
        }

        private void btnOperatorAdd_Click_1(object sender, EventArgs e)
        {
